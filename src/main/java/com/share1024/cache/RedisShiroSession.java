 ...
 * @Date : 2017/10/22
 */
public class RedisShiroSession implements ValidatingSession, Serializable {
    ...
    private transient static final Logger log = LoggerFactory.getLogger(RedisShiroSession.class);
    ...
    public RedisShiroSession(String host) {
        this();
        this.host = host;
    }
    ...
    /**
     * Returns {@code true} if the specified argument is an {@code instanceof} {@code RedisShiroSession} and both
     * {@link #getId() id}s are equal.  If the argument is a {@code RedisShiroSession} and either 'this' or the argument
     * does not yet have an ID assigned, the value of {@link #onEquals(RedisShiroSession) onEquals} is returned, which
     * does a necessary attribute-based comparison when IDs are not available.
     * <p/>
     * Do your best to ensure {@code RedisShiroSession} instances receive an ID very early in their lifecycle to
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RedisShiroSession) {
            RedisShiroSession other = (RedisShiroSession) obj;
     ...
     *
     * @param ss the RedisShiroSession instance to compare for equality.
     * @return true if all the attributes, except the id, are equal to this object's attributes.
     * @since 1.0
     */
    protected boolean onEquals(RedisShiroSession ss) {
    ...
    /**
     * Returns the string representation of this RedisShiroSession, equal to
     * <code>getClass().getName() + &quot;,id=&quot; + getId()</code>.
     *
     * @return the string representation of this RedisShiroSession, equal to
     *         <code>getClass().getName() + &quot;,id=&quot; + getId()</code>.
     * @since 1.0
     */
    @Override
